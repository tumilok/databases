-- FUNCTION DOSTEPNE WYCIECZKI2
CREATE OR REPLACE
FUNCTION fnc_dostepne_wycieczki2(kraj WYCIECZKI.KRAJ%TYPE,
    ...
    BEGIN
        ...
        WHERE wd.KRAJ = fnc_dostepne_wycieczki2.kraj AND data_od <= wd.DATA
            AND wd.DATA <= data_do;

        RETURN result_table;
    END fnc_dostepne_wycieczki2;